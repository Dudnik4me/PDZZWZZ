...
const navigation = [
  { id: "dashboard", label: "Dashboard", icon: LayoutDashboard, roles: ["Menedżer", "Pracownik"] },
  { id: "manager", label: "Panel menedżera", icon: ListTodo, roles: ["Menedżer"] },
  { id: "employee", label: "Panel pracownika", icon: UserRound, roles: ["Pracownik"] },
  { id: "notifications", label: "Powiadomienia", icon: Bell, roles: ["Menedżer", "Pracownik"] },
  { id: "reports", label: "Raporty", icon: BarChart3, roles: ["Menedżer"] }
];
...
function App() {
  ...
  const handleLogin = (user) => {
    setCurrentUser(user);
    setActiveView(user.role === "Menedżer" ? "manager" : "employee");
  };
